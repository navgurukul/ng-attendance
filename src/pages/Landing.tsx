        ...
        <div className="grid md:grid-cols-2 gap-5 items-center">
          <div className="text-center md:text-left">
            ...
            <p className="text-lg md:text-xl mb-10 text-muted-foreground max-w-xl">
              Modern attendance tracking with QR codes, leave management, and
              real-time analytics.
            </p>
      ...
      <section className="container mx-auto px-4 py-16 bg-[#f9f9f9]">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
          <Card className="p-6 border border-gray-300 bg-[#ffffff] shadow-md hover:shadow-lg rounded-xl transition-all">
            <div className="bg-[#D81B60] p-3 w-fit border border-gray-300 mb-4 rounded-[5px]">
          ...
          <Card className="p-6 border border-gray-300 bg-[#ffffff] shadow-md hover:shadow-lg rounded-xl transition-all">
            ...
            <p className="text-muted-foreground">
              Submit leave requests with type selection and approval workflow.
              Track all your leave history.
            </p>
          </Card>
          ...
          <Card className="p-6 border border-gray-300 bg-[#ffffff] shadow-md hover:shadow-lg rounded-xl transition-all">
            ...
            <p className="text-muted-foreground">
              View attendance analytics with charts and graphs. Export data in
              Excel or PDF format.
            </p>
          </Card>
          ...
          <Card className="p-6 border border-gray-300 bg-[#ffffff] shadow-md hover:shadow-lg rounded-xl transition-all">
            ...
            <p className="text-muted-foreground">
              Mark kitchen duty and get automatic attendance credit. Simple
              one-click process.
            </p>
          </Card>
          ...
          <Card className="p-6 border border-gray-300 bg-[#ffffff] shadow-md hover:shadow-lg rounded-xl transition-all">
            ...
            <p className="text-muted-foreground">
              Complete oversight of all students. Generate QR codes, approve
              leaves, and track lifecycle.
            </p>
          </Card>
          ...
          <Card className="p-6 border border-gray-300 bg-[#ffffff] shadow-md hover:shadow-lg rounded-xl transition-all">
            ...
            <p className="text-muted-foreground">
              Missed a scan? Submit correction requests with reason for admin
              review.
            </p>
          </Card>
        </div>
      ...
      <footer className="bg-gray-100 text-black pt-12 pb-6 border-t border-gray-300">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 pb-8">
            ...
            <div>
              <h3 className="text-lg font-semibold mb-4 text-[#D81B60] uppercase">
                Quick Links
              </h3>
              <ul className="space-y-2 text-sm">
                <li>
                  <Link
                    to="/features"
                    className="text-gray-800 hover:text-[#D81B60] transition-colors"
                  >
                    Core Features
                  </Link>
                </li>
            ...
            <div>
              ...
              <div className="space-y-3 text-sm">
                <div className="flex items-center text-gray-800 hover:text-[#D81B60] transition-colors">
                  <Mail className="h-5 w-5 mr-3" />
                  <a href="mailto:support@navgurukul.org">
                    support@navgurukul.org
                  </a>
                </div>
              </div>
              ...
              <div className="flex space-x-4 mt-6">
                <a
                  ...
                  aria-label="Twitter"
                >
                  <Twitter className="h-6 w-6 text-gray-700 hover:text-[#D81B60] transition-colors" />
                </a>
                <a
                  href="https://www.linkedin.com/school/navgurukul/posts/?feedView=all"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="LinkedIn"
                >
                  <Linkedin className="h-6 w-6 text-gray-700 hover:text-[#D81B60] transition-colors" />
                </a>
              </div>
            </div>
          </div>
