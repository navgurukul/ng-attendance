      ...
      <div className="flex-1 p-8 pt-[100px] md:ml-64 text-sm md:text-base lg:text-lg">
        ...
        <div className="mb-8 flex flex-col items-center">
          ...
          <p className="text-muted-foreground">
            Generate and export key attendance and leave reports.
          </p>
        </div>

        {/* MAIN CARD */}
        <Card className="p-6 bg-card max-w-6xl border-[2px] border-[#111] shadow-none">
          <div className="flex items-center gap-3 mb-6">
            <div className="p-2 border-[2px] border-[#111] bg-primary">
          ...
          <div className="space-y-3">
            <Button
              ...
              variant="outline"
              className="w-full justify-start border-[2px] border-[#111] hover:bg-muted shadow-none"
            >
        ...
        {/* REPORT HISTORY CARD */}
        {/* <Card className="mt-6 p-6 bg-muted/30 max-w-6xl border-[2px] border-[#111] border-dashed shadow-none">
          <h3 className="font-bold text-lg">Report History</h3>
          <p className="text-sm text-muted-foreground">
            All generated reports will be listed here for download.
          </p>
        </Card> */}
