        ...
        <div className="min-h-screen bg-gray-50 flex flex-col md:flex-row mb-[100px] pt-20">
            ...
            <div className="flex-1 px-4 py-6 md:px-8 md:py-10 md:ml-64 text-sm md:text-base lg:text-lg">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <Card className="p-4 md:p-6 border-[3px] border-foreground shadow-md bg-card hover:shadow-lg rounded-xl transition-all">
                        ...
                        <form onSubmit={handleLeaveSubmit} className="space-y-4">
                            <div className="space-y-2">
                                ...
                                <select
                                    ...
                                    className={cn(
                                        "w-full h-12 px-4 border-[3px] border-foreground shadow-md-sm bg-background",
                                    ...
                                    <Popover>
                                        <PopoverTrigger asChild>
                                            <Button
                                                variant="outline"
                                                className={cn(
                                                    "w-full justify-start h-12 border-[3px] shadow-md-sm",
                            ...
                            <div className="space-y-2">
                                ...
                                <Textarea
                                    ...
                                    className={cn(
                                        "border-[3px] border-foreground min-h-[120px] resize-none",
                    ...
                    <Card className="p-4 md:p-6 border-[3px] border-foreground bg-background shadow-md hover:shadow-lg rounded-xl transition-all">
                        ...
                        {leaveRequests.length === 0 ? (
                            ...
                            <div className="space-y-3 max-h-[500px] overflow-y-auto pr-2">
                                {leaveRequests.map((leave) => (
                                    <div key={leave.id} className="p-3 border-[2px] bg-muted border-foreground rounded-md">
